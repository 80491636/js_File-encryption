...
function encrypt(arrayBuffer) {
    ...
    // 添加假header到文件
    var tmpInt8Array = new Uint8Array(arrayBuffer.byteLength + getHeaderLen());
    tmpInt8Array.set(fakeHeader, 0);
    tmpInt8Array.set(new Uint8Array(arrayBuffer), getHeaderLen());

    // 检查 header 是否有效
    var header = new Uint8Array(tmpInt8Array.buffer, 0, getHeaderLen());
